    ...
    <div class="content-wrapper">
      ...
      <div class="row col-12">
        ...
        <div class="table-responsive p-3">
          ...
          <form action="{{ url('admin/attribute/edit-attribute/'.$product['id']) }}" method="POST">
            @csrf
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0)" class="confirmDelete" name="attribute" module="attribute" moduleid="{{ $attribute['id'] }}"><i style="font-size: 20px; color:red" class="fas fa-trash-alt"></i></a>
                    </td>
                </tr>
                @endforeach

      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="manage">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ route('section.index') }}">Sections</a></li>
            ...
            <li class="nav-item"> <a class="nav-link" href="{{ route('filter.index') }}">Filters</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{ route('banner.index') }}">Banners</a></li>

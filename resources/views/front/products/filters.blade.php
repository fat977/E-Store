...
<div class="col-lg-3 col-md-3 col-sm-12">
    ...
    <!-- Filter-Size -->
    <?php
       $getProductSizes = productFilter::getSizes($url);
    ?>
    @if($getProductSizes)
    <div class="facet-filter-associates">
        ...
        <form class="facet-form" action="#" method="post">
            <div class="associate-wrapper">
                    @foreach ($getProductSizes as $key => $size)
    ...
    <!-- Filter-Brand -->
    <?php
    $getBrandIds = productFilter::getBrands($url);
    ?>
    <div class="facet-filter-associates">
        <h3 class="title-name">Brand</h3>
        <form class="facet-form" action="#" method="post">
            <div class="associate-wrapper">
                @foreach ($getBrandIds as $key => $brand)
    ...
    <!-- Filter-Brand /- -->
     ...
     <div class="facet-filter-associates">
        ...
        <form class="facet-form" action="#" method="post">
            <div class="associate-wrapper">
                <?php $prices = array('0-1000','1000-2000','2000-5000','5000-10000','10000-20000');?>
    ...
    @php
        $filterAvailable = ProductFilter::filterAvailable($filter['id'],$categoryDetails['categoryDetails']
        ['id']);
    @endphp
